...
export const PerformanceIndicatorsGenTable = ({ date }: { date: { from: string; to?: string } }) => {
  const { data, isLoading, isError, error } = useQuery({
    queryKey: ["fetch-performance-indicators-gen-table"],
    queryFn: async () => {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Indicadores Demand Gen</CardTitle>
        <CardDescription>
          Tabla de indicadores clave de rendimiento para campañas Demand Gen
          <br />
